var guest_list = ["Musk", "Arnault", "Adani", "Gates"];
...
guest_list.forEach(function (guest_list) { return console.log("Hi ".concat(guest_list, ", I would be honoured to invite you for dinner.")); });
